...
namespace KEI.UI.Wpf.AttachedProperties
{
    public class TreeViewBehaviours
    {
        ...
        public static readonly DependencyProperty TreeViewSelectedItemProperty =
            DependencyProperty.RegisterAttached("TreeViewSelectedItem", typeof(object), typeof(TreeViewBehaviours), new PropertyMetadata(new object(), TreeViewSelectedItemChanged));
