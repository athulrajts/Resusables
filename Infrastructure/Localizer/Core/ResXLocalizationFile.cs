...
{
    public class ResXLocalizationFile : BindableBase
    {
        ...
        public ResXLocalizationFile(string path, string language)
        {
            FilePath = path;
            ...
            if (File.Exists(FilePath))
            {
                ...
                foreach (DictionaryEntry item in rr)
                {
                    ...
                    {
                        Resources.Add(new Translation
                        {
                            Key = item.Key.ToString(),
                            TranslatedText = item.Value.ToString()
                        });
                    }
                }
            }
